...
uses FormMain, GlobalVars, DistanceFormulas, ModelVxt, Config, FormCustom360DegAnimation;
...
procedure TFrm3DPReview.MakeaCustom360DegAnimationGIF1Click(Sender: TObject);
var
