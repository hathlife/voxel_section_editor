...
type
   TMeshDeflate = class (TMeshProcessingBase)
      protected
         procedure MeshDeflateOperation(var _Vertices: TAVector3f);
...
procedure TMeshDeflate.DoMeshProcessing(var _Mesh: TMesh);
begin
   MeshDeflateOperation(_Mesh.Vertices);
   _Mesh.ForceRefresh;
end;

procedure TMeshDeflate.MeshDeflateOperation(var _Vertices: TAVector3f);
var
   v : integer;
