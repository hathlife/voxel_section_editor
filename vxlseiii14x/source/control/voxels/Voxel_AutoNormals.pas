...
// Warning: The code from this file was written in Portuguese (BR) language because it is
// a feature that was published in a brazilian symposium (SIBGRAPI 2007: Simpósio
// Brasileiro de Computação Gráfica e Processamento de Imagens). The short paper
// of this feature is called "Finding Surface Normals From Voxels" and it is has
// been written in English (USA).

// Atenção: O código deste arquivo foi escrito em Português do Brasil porque esta
// funcionalidade foi publicada no SIBGRAPI 2007: Simpósio Brasileiro de Computação
// Gráfica e Processamento de Imagens. O short paper desta funcionalidade chama-se
// "Finding Surface Normals From Voxels" e foi escrito em Inglês (EUA).
