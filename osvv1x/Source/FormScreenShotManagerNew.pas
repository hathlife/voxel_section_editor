...
procedure TFrmScreenShotManager_New.SpeedButton1Click(Sender: TObject);
begin
 MainViewWidth.Value := VVFrmMain.MainView.Width;
end;

procedure TFrmScreenShotManager_New.SpeedButton2Click(Sender: TObject);
begin
 MainViewHeight.Value := VVFrmMain.MainView.Height;
end;
