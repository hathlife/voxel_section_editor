   ...
   begin
      ...
      begin
         ...
         begin
            ...
            writeln(F);
            writeln(F, FloatToStrF(GetTMValue(HVAFile,1,1,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVAFile,1,2,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVAFile,1,3,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVAFile,1,4,SectionNum,1),ffFixed,15,17));
            writeln(F, FloatToStrF(GetTMValue(HVAFile,2,1,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVAFile,2,2,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVAFile,2,3,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVAFile,2,4,SectionNum,1),ffFixed,15,17));
            writeln(F, FloatToStrF(GetTMValue(HVAFile,3,1,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVAFile,3,2,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVAFile,3,3,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVAFile,3,4,SectionNum,1),ffFixed,15,17));
            writeln(F, FloatToStrF(GetTMValue(HVAFile,4,1,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVAFile,4,2,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVAFile,4,3,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVAFile,4,4,SectionNum,1),ffFixed,15,17));
            writeln(F);
            writeln(F);
            writeln(F);
            writeln(F,'Transformation Calculations:');
            writeln(F);
            x := (VoxelFile.Section[SectionNum].Tailer.MinBounds[1] * GetTMValue(HVAFile,1,1,SectionNum,1)) + (VoxelFile.Section[SectionNum].Tailer.MinBounds[2] * GetTMValue(HVAFile,1,2,SectionNum,1)) + (VoxelFile.Section[SectionNum].Tailer.MinBounds[3] * GetTMValue(HVAFile,1,3,SectionNum,1)) + GetTMValue(HVAFile,1,4,SectionNum,1);
            y := (VoxelFile.Section[SectionNum].Tailer.MinBounds[1] * GetTMValue(HVAFile,2,1,SectionNum,1)) + (VoxelFile.Section[SectionNum].Tailer.MinBounds[2] * GetTMValue(HVAFile,2,2,SectionNum,1)) + (VoxelFile.Section[SectionNum].Tailer.MinBounds[3] * GetTMValue(HVAFile,2,3,SectionNum,1)) + GetTMValue(HVAFile,2,4,SectionNum,1);
            z := (VoxelFile.Section[SectionNum].Tailer.MinBounds[1] * GetTMValue(HVAFile,3,1,SectionNum,1)) + (VoxelFile.Section[SectionNum].Tailer.MinBounds[2] * GetTMValue(HVAFile,3,2,SectionNum,1)) + (VoxelFile.Section[SectionNum].Tailer.MinBounds[3] * GetTMValue(HVAFile,3,3,SectionNum,1)) + GetTMValue(HVAFile,3,4,SectionNum,1);
            w := (VoxelFile.Section[SectionNum].Tailer.MinBounds[1] * GetTMValue(HVAFile,4,1,SectionNum,1)) + (VoxelFile.Section[SectionNum].Tailer.MinBounds[2] * GetTMValue(HVAFile,4,2,SectionNum,1)) + (VoxelFile.Section[SectionNum].Tailer.MinBounds[3] * GetTMValue(HVAFile,4,3,SectionNum,1)) + GetTMValue(HVAFile,4,4,SectionNum,1);
            ...
            x := (VoxelFile.Section[SectionNum].Tailer.MaxBounds[1] * GetTMValue(HVAFile,1,1,SectionNum,1)) + (VoxelFile.Section[SectionNum].Tailer.MaxBounds[2] * GetTMValue(HVAFile,1,2,SectionNum,1)) + (VoxelFile.Section[SectionNum].Tailer.MaxBounds[3] * GetTMValue(HVAFile,1,3,SectionNum,1)) + GetTMValue(HVAFile,1,4,SectionNum,1);
            y := (VoxelFile.Section[SectionNum].Tailer.MaxBounds[1] * GetTMValue(HVAFile,2,1,SectionNum,1)) + (VoxelFile.Section[SectionNum].Tailer.MaxBounds[2] * GetTMValue(HVAFile,2,2,SectionNum,1)) + (VoxelFile.Section[SectionNum].Tailer.MaxBounds[3] * GetTMValue(HVAFile,2,3,SectionNum,1)) + GetTMValue(HVAFile,2,4,SectionNum,1);
            z := (VoxelFile.Section[SectionNum].Tailer.MaxBounds[1] * GetTMValue(HVAFile,3,1,SectionNum,1)) + (VoxelFile.Section[SectionNum].Tailer.MaxBounds[2] * GetTMValue(HVAFile,3,2,SectionNum,1)) + (VoxelFile.Section[SectionNum].Tailer.MaxBounds[3] * GetTMValue(HVAFile,3,3,SectionNum,1)) + GetTMValue(HVAFile,3,4,SectionNum,1);
            w := (VoxelFile.Section[SectionNum].Tailer.MaxBounds[1] * GetTMValue(HVAFile,4,1,SectionNum,1)) + (VoxelFile.Section[SectionNum].Tailer.MaxBounds[2] * GetTMValue(HVAFile,4,2,SectionNum,1)) + (VoxelFile.Section[SectionNum].Tailer.MaxBounds[3] * GetTMValue(HVAFile,4,3,SectionNum,1)) + GetTMValue(HVAFile,4,4,SectionNum,1);
         ...
         begin
            ...
            begin
               ...
               writeln(F,'Transformation Matrix: ');
               writeln(F);
               writeln(F, FloatToStrF(GetTMValue(HVATurret,1,1,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVATurret,1,2,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVATurret,1,3,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVATurret,1,4,SectionNum,1),ffFixed,15,17));
               writeln(F, FloatToStrF(GetTMValue(HVATurret,2,1,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVATurret,2,2,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVATurret,2,3,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVATurret,2,4,SectionNum,1),ffFixed,15,17));
               writeln(F, FloatToStrF(GetTMValue(HVATurret,3,1,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVATurret,3,2,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVATurret,3,3,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVATurret,3,4,SectionNum,1),ffFixed,15,17));
               writeln(F, FloatToStrF(GetTMValue(HVATurret,4,1,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVATurret,4,2,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVATurret,4,3,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVATurret,4,4,SectionNum,1),ffFixed,15,17));
               writeln(F);
               writeln(F);
               writeln(F);
               writeln(F,'Transformation Calculations:');
               writeln(F);
               x := (VoxelTurret.Section[SectionNum].Tailer.MinBounds[1] * GetTMValue(HVATurret,1,1,SectionNum,1)) + (VoxelTurret.Section[SectionNum].Tailer.MinBounds[2] * GetTMValue(HVATurret,1,2,SectionNum,1)) + (VoxelTurret.Section[SectionNum].Tailer.MinBounds[3] * GetTMValue(HVATurret,1,3,SectionNum,1)) + GetTMValue(HVATurret,1,4,SectionNum,1);
               y := (VoxelTurret.Section[SectionNum].Tailer.MinBounds[1] * GetTMValue(HVATurret,2,1,SectionNum,1)) + (VoxelTurret.Section[SectionNum].Tailer.MinBounds[2] * GetTMValue(HVATurret,2,2,SectionNum,1)) + (VoxelTurret.Section[SectionNum].Tailer.MinBounds[3] * GetTMValue(HVATurret,2,3,SectionNum,1)) + GetTMValue(HVATurret,2,4,SectionNum,1);
               z := (VoxelTurret.Section[SectionNum].Tailer.MinBounds[1] * GetTMValue(HVATurret,3,1,SectionNum,1)) + (VoxelTurret.Section[SectionNum].Tailer.MinBounds[2] * GetTMValue(HVATurret,3,2,SectionNum,1)) + (VoxelTurret.Section[SectionNum].Tailer.MinBounds[3] * GetTMValue(HVATurret,3,3,SectionNum,1)) + GetTMValue(HVATurret,3,4,SectionNum,1);
               w := (VoxelTurret.Section[SectionNum].Tailer.MinBounds[1] * GetTMValue(HVATurret,4,1,SectionNum,1)) + (VoxelTurret.Section[SectionNum].Tailer.MinBounds[2] * GetTMValue(HVATurret,4,2,SectionNum,1)) + (VoxelTurret.Section[SectionNum].Tailer.MinBounds[3] * GetTMValue(HVATurret,4,3,SectionNum,1)) + GetTMValue(HVATurret,4,4,SectionNum,1);
               writeln(F, 'MinBounds: (' + FloatToStr(x) + ', ' + FloatToStr(y) + ', ' + FloatToStr(z) + ', ' + FloatToStr(w) + ')');
               if (w <> 0) then
                  writeln(F, 'MinBounds Normalized: (' + FloatToStr(x/w) + ', ' + FloatToStr(y/w) + ', ' + FloatToStr(z/w) + ', ' + FloatToStr(w/w) + ')');
               x := (VoxelTurret.Section[SectionNum].Tailer.MaxBounds[1] * GetTMValue(HVATurret,1,1,SectionNum,1)) + (VoxelTurret.Section[SectionNum].Tailer.MaxBounds[2] * GetTMValue(HVATurret,1,2,SectionNum,1)) + (VoxelTurret.Section[SectionNum].Tailer.MaxBounds[3] * GetTMValue(HVATurret,1,3,SectionNum,1)) + GetTMValue(HVATurret,1,4,SectionNum,1);
               y := (VoxelTurret.Section[SectionNum].Tailer.MaxBounds[1] * GetTMValue(HVATurret,2,1,SectionNum,1)) + (VoxelTurret.Section[SectionNum].Tailer.MaxBounds[2] * GetTMValue(HVATurret,2,2,SectionNum,1)) + (VoxelTurret.Section[SectionNum].Tailer.MaxBounds[3] * GetTMValue(HVATurret,2,3,SectionNum,1)) + GetTMValue(HVATurret,2,4,SectionNum,1);
               z := (VoxelTurret.Section[SectionNum].Tailer.MaxBounds[1] * GetTMValue(HVATurret,3,1,SectionNum,1)) + (VoxelTurret.Section[SectionNum].Tailer.MaxBounds[2] * GetTMValue(HVATurret,3,2,SectionNum,1)) + (VoxelTurret.Section[SectionNum].Tailer.MaxBounds[3] * GetTMValue(HVATurret,3,3,SectionNum,1)) + GetTMValue(HVATurret,3,4,SectionNum,1);
               w := (VoxelTurret.Section[SectionNum].Tailer.MaxBounds[1] * GetTMValue(HVATurret,4,1,SectionNum,1)) + (VoxelTurret.Section[SectionNum].Tailer.MaxBounds[2] * GetTMValue(HVATurret,4,2,SectionNum,1)) + (VoxelTurret.Section[SectionNum].Tailer.MaxBounds[3] * GetTMValue(HVATurret,4,3,SectionNum,1)) + GetTMValue(HVATurret,4,4,SectionNum,1);
               writeln(F, 'MaxBounds: (' + FloatToStr(x) + ', ' + FloatToStr(y) + ', ' + FloatToStr(z) + ', ' + FloatToStr(w) + ')');
               if (w <> 0) then
                  writeln(F, 'MaxBounds Normalized: (' + FloatToStr(x/w) + ', ' + FloatToStr(y/w) + ', ' + FloatToStr(z/w) + ', ' + FloatToStr(w/w) + ')');
               writeln(F);
         ...
         begin
            ...
            begin
               ...
               writeln(F,'Transformation Matrix: ');
               writeln(F);
               writeln(F, FloatToStrF(GetTMValue(HVABarrel,1,1,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVABarrel,1,2,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVABarrel,1,3,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVABarrel,1,4,SectionNum,1),ffFixed,15,17));
               writeln(F, FloatToStrF(GetTMValue(HVABarrel,2,1,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVABarrel,2,2,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVABarrel,2,3,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVABarrel,2,4,SectionNum,1),ffFixed,15,17));
               writeln(F, FloatToStrF(GetTMValue(HVABarrel,3,1,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVABarrel,3,2,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVABarrel,3,3,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVABarrel,3,4,SectionNum,1),ffFixed,15,17));
               writeln(F, FloatToStrF(GetTMValue(HVABarrel,4,1,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVABarrel,4,2,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVABarrel,4,3,SectionNum,1),ffFixed,15,17) + ' :: ' + FloatToStrF(GetTMValue(HVABarrel,4,4,SectionNum,1),ffFixed,15,17));
               writeln(F);
               writeln(F);
               writeln(F);
               writeln(F,'Transformation Calculations:');
               writeln(F);
               x := (VoxelBarrel.Section[SectionNum].Tailer.MinBounds[1] * GetTMValue(HVABarrel,1,1,SectionNum,1)) + (VoxelBarrel.Section[SectionNum].Tailer.MinBounds[2] * GetTMValue(HVABarrel,1,2,SectionNum,1)) + (VoxelBarrel.Section[SectionNum].Tailer.MinBounds[3] * GetTMValue(HVABarrel,1,3,SectionNum,1)) + GetTMValue(HVABarrel,1,4,SectionNum,1);
               y := (VoxelBarrel.Section[SectionNum].Tailer.MinBounds[1] * GetTMValue(HVABarrel,2,1,SectionNum,1)) + (VoxelBarrel.Section[SectionNum].Tailer.MinBounds[2] * GetTMValue(HVABarrel,2,2,SectionNum,1)) + (VoxelBarrel.Section[SectionNum].Tailer.MinBounds[3] * GetTMValue(HVABarrel,2,3,SectionNum,1)) + GetTMValue(HVABarrel,2,4,SectionNum,1);
               z := (VoxelBarrel.Section[SectionNum].Tailer.MinBounds[1] * GetTMValue(HVABarrel,3,1,SectionNum,1)) + (VoxelBarrel.Section[SectionNum].Tailer.MinBounds[2] * GetTMValue(HVABarrel,3,2,SectionNum,1)) + (VoxelBarrel.Section[SectionNum].Tailer.MinBounds[3] * GetTMValue(HVABarrel,3,3,SectionNum,1)) + GetTMValue(HVABarrel,3,4,SectionNum,1);
               w := (VoxelBarrel.Section[SectionNum].Tailer.MinBounds[1] * GetTMValue(HVABarrel,4,1,SectionNum,1)) + (VoxelBarrel.Section[SectionNum].Tailer.MinBounds[2] * GetTMValue(HVABarrel,4,2,SectionNum,1)) + (VoxelBarrel.Section[SectionNum].Tailer.MinBounds[3] * GetTMValue(HVABarrel,4,3,SectionNum,1)) + GetTMValue(HVABarrel,4,4,SectionNum,1);
               writeln(F, 'MinBounds: (' + FloatToStr(x) + ', ' + FloatToStr(y) + ', ' + FloatToStr(z) + ', ' + FloatToStr(w) + ')');
               if (w <> 0) then
                  writeln(F, 'MinBounds Normalized: (' + FloatToStr(x/w) + ', ' + FloatToStr(y/w) + ', ' + FloatToStr(z/w) + ', ' + FloatToStr(w/w) + ')');
               x := (VoxelBarrel.Section[SectionNum].Tailer.MaxBounds[1] * GetTMValue(HVABarrel,1,1,SectionNum,1)) + (VoxelBarrel.Section[SectionNum].Tailer.MaxBounds[2] * GetTMValue(HVABarrel,1,2,SectionNum,1)) + (VoxelBarrel.Section[SectionNum].Tailer.MaxBounds[3] * GetTMValue(HVABarrel,1,3,SectionNum,1)) + GetTMValue(HVABarrel,1,4,SectionNum,1);
               y := (VoxelBarrel.Section[SectionNum].Tailer.MaxBounds[1] * GetTMValue(HVABarrel,2,1,SectionNum,1)) + (VoxelBarrel.Section[SectionNum].Tailer.MaxBounds[2] * GetTMValue(HVABarrel,2,2,SectionNum,1)) + (VoxelBarrel.Section[SectionNum].Tailer.MaxBounds[3] * GetTMValue(HVABarrel,2,3,SectionNum,1)) + GetTMValue(HVABarrel,2,4,SectionNum,1);
               z := (VoxelBarrel.Section[SectionNum].Tailer.MaxBounds[1] * GetTMValue(HVABarrel,3,1,SectionNum,1)) + (VoxelBarrel.Section[SectionNum].Tailer.MaxBounds[2] * GetTMValue(HVABarrel,3,2,SectionNum,1)) + (VoxelBarrel.Section[SectionNum].Tailer.MaxBounds[3] * GetTMValue(HVABarrel,3,3,SectionNum,1)) + GetTMValue(HVABarrel,3,4,SectionNum,1);
               w := (VoxelBarrel.Section[SectionNum].Tailer.MaxBounds[1] * GetTMValue(HVABarrel,4,1,SectionNum,1)) + (VoxelBarrel.Section[SectionNum].Tailer.MaxBounds[2] * GetTMValue(HVABarrel,4,2,SectionNum,1)) + (VoxelBarrel.Section[SectionNum].Tailer.MaxBounds[3] * GetTMValue(HVABarrel,4,3,SectionNum,1)) + GetTMValue(HVABarrel,4,4,SectionNum,1);
               writeln(F, 'MaxBounds: (' + FloatToStr(x) + ', ' + FloatToStr(y) + ', ' + FloatToStr(z) + ', ' + FloatToStr(w) + ')');
               if (w <> 0) then
                  writeln(F, 'MaxBounds Normalized: (' + FloatToStr(x/w) + ', ' + FloatToStr(y/w) + ', ' + FloatToStr(z/w) + ', ' + FloatToStr(w/w) + ')');
               writeln(F);
