...
var
   i, j: integer;
begin
   Tailer.Det := 0.83333; // TODO: review if this is correct in all cases etc
   // TODO: check this logic is correct- was done from memory!
   for i := 1 to 3 do
   ...
   // TODO: check this logic is correct- was done from memory!
   Tailer.MaxBounds[1] := (Tailer.XSize / 2) * Tailer.Det;
   Tailer.MaxBounds[2] := (Tailer.YSize / 2) * Tailer.Det;
   Tailer.MaxBounds[3] := (Tailer.ZSize / 2) * Tailer.Det;
   Tailer.MinBounds[1] := 0 - Tailer.MaxBounds[1];
   Tailer.MinBounds[2] := 0 - Tailer.MaxBounds[2];
   Tailer.MinBounds[3] := 0 - Tailer.MaxBounds[3];
end;
...
// <><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
// <><><><><><><><><><><> getPhysicalCursorCoords Starts Here<><><><><>
// <><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
begin
   case Orient of
      oriX: TranslateX;
