...
var
   pointOnPlane, tempVect, dir : TVector3f;
   d : single;
begin
...
var
   pointOnPlane, tempVect, dir, point : TVector3f;
   d : single;
begin
...
function GetPosWithSize(Position : TVector3f; Size : single) : TVector3f;
begin
   Result.X := Position.X * (Size *2);
   Result.Y := Position.Y * (Size *2);
   Result.Z := Position.Z * (Size *2);
end;
